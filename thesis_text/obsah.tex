...
cases a different user is the \textbf{root}. Security policies which define
...
between entries\footnote{http://tools.ietf.org/html/draft-masarati-ldap-deref-00#section-1}
