...
specifikován pouze jako øetìzec znakù, ale jako odkaz na ji¾ existující objekt
dané domény. 
...
backend a respondeøi z~ní mohou data pouze èíst. Tato cache pamì» se také
oznaèuje jako \emph{sysdb}.
...
zvá¾it pøi návrhu nativního IPA SUDO providera. Sekce implementace popisuje
jak a které z tìchto pøístupù byly vybrány pro implementaci nového providera.
V sekci testování je poté popsána metodika a nástroje vyu¾ité k otestování
navr¾ených øe¹ení.

\section{Návrh}
Tato sekce popisuje mo¾né pøístupy ke sta¾ení a zpracování SUDO pravidel,
