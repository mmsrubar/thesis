...
\projectinfo{
  ...
  %Abstract
  abstract.cs={
	Cílem této bakaláøské práce je zlep¹ení integrace mezi SUDO a SSSD se
	zamìøením na vylep¹ení podpory SUDO pravidel ulo¾ených na serveru FreeIPA.
	Zabývá se popisem LDAP SUDO provideru a prezentuje návrh a implementaci IPA SUDO
	providera. Navr¾ený provider eliminuje nadbyteènou re¾ii pøekládání SUDO
  ...
  %Podekovani (nepovinne)
	acknowledgment={Rád bych podìkoval  prof. Tomá¹i Vojnarovi za ve¹kerou
		poskytnutou pomoc. Dále mému technickému vedoucímu, ing. Jakubu Hrozkovi za
